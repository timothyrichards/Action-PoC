...
namespace CrusadersArena.Editor
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "Bootstrap/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "Bootstrap/Don't Load Bootstrap Scene On Play";

        const string k_TestRunnerSceneName = "Startup";
